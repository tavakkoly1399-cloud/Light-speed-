          ...
          Row(
            children: [
              ...
              if (servers.isNotEmpty)
                Text(
                  '${servers.where((s) => s.ping != null).length} تست‌شده',
                ),
            ],
          ),
        ),
      ...
      children: [
        ...
        card(
          const ListTile(
            ...
            subtitle: Text(
              'sing-box URLTest بهترین مسیر را انتخاب می‌کند',
            ),
          ),
        ),
